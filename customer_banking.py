...
def main():
    ...
    savings_maturity = int(input('Enter the months: '))
    ...
    # ADD YOUR CODE HERE
    print(f"Your new savings balance is $', {new_balance:,.2f}")
    print(f"Your interest rate is {savings_interest:.2f}")
    print(f"you earned {updated_savings_balance - savings_balance} over {savings_maturity} months")

    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    # ADD YOUR CODE HERE
    cd_balance = float(input('Enter your starting balance: '))
    cd_interest = float(input('Enter your CD interest rate: '))
    cd_maturity = int(input('Enter the months: '))
    ...
    print(f"you earned {updated_cd_balance - cd_balance} over {cd_maturity} months.")
