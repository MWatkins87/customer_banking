...
def main():
    ...
    # ADD YOUR CODE HERE
    savings_balance = check_input("Enter your starting balance: ", "float")
    savings_interest = check_input("Enter your savings interest rate: ", "float")
    savings_maturity = check_input("Enter the months: ", "int")
    ...
    # ADD YOUR CODE HERE
    cd_balance = check_input("Enter your starting CD balance:", "float")
    cd_interest = check_input("Enter your CD interest rate:", "float")
    cd_maturity = check_input("Enter the CD months: ", "int")
